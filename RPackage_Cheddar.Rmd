...
##Cheddar##
  ...
  - Range of functions for analysis and visulaization  
    ...
    + Allows for inter-web comparisons (changes in community structure over environmental, temporal, or spatial gradient)
```{r}
# load package
library(cheddar)
# load data
...
###Chesapeake Bay Data, Symbolizing Links###
```{r}
# ChesapeakeBay Data
data(ChesapeakeBay)
# plot basic food web
